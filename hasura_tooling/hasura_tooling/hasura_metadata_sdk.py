...
class Header:
    ...
    def to_dict(self) -> dict:
        ...
        result["value_from_env"] = from_union(
            [from_str, from_none], self.value_from_env
        )
        return result
...
class ActionDefinition:
    ...
    def from_dict(obj: Any) -> "ActionDefinition":
        ...
        arguments = from_union(
            [lambda x: from_list(InputArgument.from_dict, x), from_none],
            obj.get("arguments"),
        )
        forward_client_headers = from_union(
            [from_bool, from_none], obj.get("forward_client_headers")
        )
        headers = from_union(
        ...
        return ActionDefinition(
            handler, arguments, forward_client_headers, headers, kind, output_type, type
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["arguments"] = from_union(
            [lambda x: from_list(lambda x: to_class(InputArgument, x), x), from_none],
            self.arguments,
        )
        result["forward_client_headers"] = from_union(
        ...
        result["type"] = from_union(
            [lambda x: to_enum(ActionDefinitionType, x), from_none], self.type
        )
        return result
...
class Action:
    ...
    def from_dict(obj: Any) -> "Action":
        ...
        permissions = from_union(
            [Permissions.from_dict, from_none], obj.get("permissions")
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["permissions"] = from_union(
            [lambda x: to_class(Permissions, x), from_none], self.permissions
        )
        return result
...
class RetryConfST:
    ...
    def from_dict(obj: Any) -> "RetryConfST":
        ...
        retry_interval_seconds = from_union(
            [from_int, from_none], obj.get("retry_interval_seconds")
        )
        timeout_seconds = from_union([from_int, from_none], obj.get("timeout_seconds"))
        tolerance_seconds = from_union(
            [from_int, from_none], obj.get("tolerance_seconds")
        )
        return RetryConfST(
            num_retries, retry_interval_seconds, timeout_seconds, tolerance_seconds
        )

    def to_dict(self) -> dict:
        result: dict = {}
        result["num_retries"] = from_union([from_int, from_none], self.num_retries)
        result["retry_interval_seconds"] = from_union(
            [from_int, from_none], self.retry_interval_seconds
        )
        result["timeout_seconds"] = from_union(
            [from_int, from_none], self.timeout_seconds
        )
        result["tolerance_seconds"] = from_union(
            [from_int, from_none], self.tolerance_seconds
        )
        return result
...
class CronTrigger:
    ...
    def from_dict(obj: Any) -> "CronTrigger":
        ...
        comment = from_union([from_str, from_none], obj.get("comment"))
        payload = from_union(
            [lambda x: from_dict(lambda x: x, x), from_none], obj.get("payload")
        )
        retry_conf = from_union(
            [RetryConfST.from_dict, from_none], obj.get("retry_conf")
        )
        return CronTrigger(
            headers,
            include_in_metadata,
    ...
    def to_dict(self) -> dict:
        ...
        result["payload"] = from_union(
            [lambda x: from_dict(lambda x: x, x), from_none], self.payload
        )
        result["retry_conf"] = from_union(
            [lambda x: to_class(RetryConfST, x), from_none], self.retry_conf
        )
        return result
...
class CustomTypeObjectRelationship:
    ...
    def from_dict(obj: Any) -> "CustomTypeObjectRelationship":
        ...
        name = from_str(obj.get("name"))
        remote_table = from_union(
            [QualifiedTable.from_dict, from_str], obj.get("remote_table")
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["name"] = from_str(self.name)
        result["remote_table"] = from_union(
            [lambda x: to_class(QualifiedTable, x), from_str], self.remote_table
        )
...
class ObjectType:
    ...
    def from_dict(obj: Any) -> "ObjectType":
        ...
        name = from_str(obj.get("name"))
        description = from_union([from_str, from_none], obj.get("description"))
        relationships = from_union(
            [lambda x: from_list(CustomTypeObjectRelationship.from_dict, x), from_none],
    ...
    def to_dict(self) -> dict:
        ...
        result["name"] = from_str(self.name)
        result["description"] = from_union([from_str, from_none], self.description)
        result["relationships"] = from_union(
            [
                lambda x: from_list(
                    lambda x: to_class(CustomTypeObjectRelationship, x), x
                ),
                from_none,
            ],
            self.relationships,
...
class CustomTypes:
    ...
    def from_dict(obj: Any) -> "CustomTypes":
        assert isinstance(obj, dict)
        enums = from_union(
            [lambda x: from_list(EnumType.from_dict, x), from_none], obj.get("enums")
        )
        input_objects = from_union(
            [lambda x: from_list(InputObjectType.from_dict, x), from_none],
            obj.get("input_objects"),
        )
        objects = from_union(
            [lambda x: from_list(ObjectType.from_dict, x), from_none],
            obj.get("objects"),
        )
        scalars = from_union(
            [lambda x: from_list(ScalarType.from_dict, x), from_none],
            obj.get("scalars"),
        )
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["enums"] = from_union(
            [lambda x: from_list(lambda x: to_class(EnumType, x), x), from_none],
            self.enums,
        )
        result["input_objects"] = from_union(
            [lambda x: from_list(lambda x: to_class(InputObjectType, x), x), from_none],
            self.input_objects,
        )
        result["objects"] = from_union(
            [lambda x: from_list(lambda x: to_class(ObjectType, x), x), from_none],
            self.objects,
        )
        result["scalars"] = from_union(
            [lambda x: from_list(lambda x: to_class(ScalarType, x), x), from_none],
            self.scalars,
        )
        return result
...
class FunctionConfiguration:
    ...
    def from_dict(obj: Any) -> "FunctionConfiguration":
        ...
        session_argument = from_union(
            [from_str, from_none], obj.get("session_argument")
        )
        return FunctionConfiguration(session_argument)

    def to_dict(self) -> dict:
        result: dict = {}
        result["session_argument"] = from_union(
...
class CustomFunction:
    ...
    def from_dict(obj: Any) -> "CustomFunction":
        assert isinstance(obj, dict)
        function = from_union(
            [QualifiedFunction.from_dict, from_str], obj.get("function")
        )
        configuration = from_union(
            [FunctionConfiguration.from_dict, from_none], obj.get("configuration")
        )
        return CustomFunction(function, configuration)

    def to_dict(self) -> dict:
        result: dict = {}
        result["function"] = from_union(
            [lambda x: to_class(QualifiedFunction, x), from_str], self.function
        )
        result["configuration"] = from_union(
            [lambda x: to_class(FunctionConfiguration, x), from_none],
            self.configuration,
        )
        return result
...
class RemoteSchemaDef:
    ...
    def from_dict(obj: Any) -> "RemoteSchemaDef":
        ...
        timeout_seconds = from_union(
            [from_float, from_none], obj.get("timeout_seconds")
        )
        url = from_union([from_str, from_none], obj.get("url"))
        url_from_env = from_union([from_str, from_none], obj.get("url_from_env"))
        return RemoteSchemaDef(
            forward_client_headers, headers, timeout_seconds, url, url_from_env
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["timeout_seconds"] = from_union(
            [to_float, from_none], self.timeout_seconds
        )
...
class ArrRelUsingFKeyOn:
    ...
    def to_dict(self) -> dict:
        ...
        result["table"] = from_union(
            [lambda x: to_class(QualifiedTable, x), from_str], self.table
        )
        return result
...
class ArrRelUsing:
    ...
    def from_dict(obj: Any) -> "ArrRelUsing":
        ...
        foreign_key_constraint_on = from_union(
            [ArrRelUsingFKeyOn.from_dict, from_none],
            obj.get("foreign_key_constraint_on"),
        )
        manual_configuration = from_union(
            [ArrRelUsingManualMapping.from_dict, from_none],
            obj.get("manual_configuration"),
        )
        return ArrRelUsing(foreign_key_constraint_on, manual_configuration)

    def to_dict(self) -> dict:
        result: dict = {}
        result["foreign_key_constraint_on"] = from_union(
            [lambda x: to_class(ArrRelUsingFKeyOn, x), from_none],
            self.foreign_key_constraint_on,
        )
        result["manual_configuration"] = from_union(
            [lambda x: to_class(ArrRelUsingManualMapping, x), from_none],
...
class ComputedFieldDefinition:
    ...
    def to_dict(self) -> dict:
        ...
        result["table_argument"] = from_union(
            [from_str, from_none], self.table_argument
        )
        return result
...
class CustomRootFields:
    ...
    def from_dict(obj: Any) -> "CustomRootFields":
        ...
        select_aggregate = from_union(
            [from_str, from_none], obj.get("select_aggregate")
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["select_aggregate"] = from_union(
            [from_str, from_none], self.select_aggregate
        )
...
class TableConfig:
    ...
    def from_dict(obj: Any) -> "TableConfig":
        ...
        custom_column_names = from_union(
            ...
            obj.get("custom_column_names"),
        )
        custom_root_fields = from_union(
            [CustomRootFields.from_dict, from_none], obj.get("custom_root_fields")
        )
        return TableConfig(custom_column_names, custom_root_fields)

    def to_dict(self) -> dict:
        result: dict = {}
        result["custom_column_names"] = from_union(
            [lambda x: from_dict(from_str, x), from_none], self.custom_column_names
        )
        result["custom_root_fields"] = from_union(
            [lambda x: to_class(CustomRootFields, x), from_none],
            self.custom_root_fields,
        )
        return result
    ...
    def from_dict(obj: Any) -> "DeletePermission":
        ...
        filter = from_union(
            [
                lambda x: from_dict(
                    lambda x: from_union(
                        [lambda x: from_dict(lambda x: x, x), from_float, from_str], x
                    ),
                    x,
                ),
                from_none,
    ...
    def to_dict(self) -> dict:
        ...
        result["filter"] = from_union(
            [
                lambda x: from_dict(
                    lambda x: from_union(
                        [lambda x: from_dict(lambda x: x, x), to_float, from_str], x
                    ),
                    x,
                ),
                from_none,
...
class OperationSpec:
    ...
    def from_dict(obj: Any) -> "OperationSpec":
        assert isinstance(obj, dict)
        columns = from_union(
            [lambda x: from_list(from_str, x), EventTriggerColumnsEnum],
            obj.get("columns"),
        )
        payload = from_union(
            [lambda x: from_list(from_str, x), EventTriggerColumnsEnum, from_none],
            obj.get("payload"),
        )
...
class EventTriggerDefinition:
    ...
    def to_dict(self) -> dict:
        ...
        result["delete"] = from_union(
            [lambda x: to_class(OperationSpec, x), from_none], self.delete
        )
        result["insert"] = from_union(
            [lambda x: to_class(OperationSpec, x), from_none], self.insert
        )
        result["update"] = from_union(
            [lambda x: to_class(OperationSpec, x), from_none], self.update
        )
        return result
...
class EventTrigger:
    ...
    def from_dict(obj: Any) -> "EventTrigger":
        ...
        webhook_from_env = from_union(
            [from_str, from_none], obj.get("webhook_from_env")
        )
        return EventTrigger(
            definition, name, retry_conf, headers, webhook, webhook_from_env
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["webhook_from_env"] = from_union(
            [from_str, from_none], self.webhook_from_env
        )
        return result
...
class InsertPermission:
    ...
    def to_dict(self) -> dict:
        ...
        result["set"] = from_union(
            [lambda x: from_dict(from_str, x), from_none], self.set
        )
        return result
...
class ObjRelUsing:
    ...
    def from_dict(obj: Any) -> "ObjRelUsing":
        assert isinstance(obj, dict)
        foreign_key_constraint_on = from_union(
            [from_str, from_none], obj.get("foreign_key_constraint_on")
        )
        manual_configuration = from_union(
            [ObjRelUsingManualMapping.from_dict, from_none],
            obj.get("manual_configuration"),
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["manual_configuration"] = from_union(
            [lambda x: to_class(ObjRelUsingManualMapping, x), from_none],
            self.manual_configuration,
        )
        return result
...
class RemoteFieldValue:
    ...
    def from_dict(obj: Any) -> "RemoteFieldValue":
        ...
        field = from_union(
            [lambda x: from_dict(RemoteFieldValue.from_dict, x), from_none],
            obj.get("field"),
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["field"] = from_union(
            [
                lambda x: from_dict(lambda x: to_class(RemoteFieldValue, x), x),
                from_none,
            ],
            self.field,
        )
...
class RemoteRelationshipDef:
    ...
    def to_dict(self) -> dict:
        ...
        result["remote_field"] = from_dict(
            lambda x: to_class(RemoteFieldValue, x), self.remote_field
        )
...
class SelectPermission:
    ...
    def from_dict(obj: Any) -> "SelectPermission":
        ...
        allow_aggregations = from_union(
            [from_bool, from_none], obj.get("allow_aggregations")
        )
        computed_fields = from_union(
            [lambda x: from_list(from_str, x), from_none], obj.get("computed_fields")
        )
        filter = from_union(
            [
                lambda x: from_dict(
        ...
        return SelectPermission(
            columns, allow_aggregations, computed_fields, filter, limit
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["allow_aggregations"] = from_union(
            [from_bool, from_none], self.allow_aggregations
        )
        result["computed_fields"] = from_union(
            [lambda x: from_list(from_str, x), from_none], self.computed_fields
        )
        result["filter"] = from_union(
            [
                lambda x: from_dict(
...
class TableEntry:
    ...
    def from_dict(obj: Any) -> "TableEntry":
        ...
        array_relationships = from_union(
            [lambda x: from_list(ArrayRelationship.from_dict, x), from_none],
            obj.get("array_relationships"),
        )
        computed_fields = from_union(
            [lambda x: from_list(ComputedField.from_dict, x), from_none],
            obj.get("computed_fields"),
        )
        configuration = from_union(
            [TableConfig.from_dict, from_none], obj.get("configuration")
        )
        delete_permissions = from_union(
            [lambda x: from_list(DeletePermissionEntry.from_dict, x), from_none],
            obj.get("delete_permissions"),
        )
        event_triggers = from_union(
            [lambda x: from_list(EventTrigger.from_dict, x), from_none],
            obj.get("event_triggers"),
        )
        insert_permissions = from_union(
            [lambda x: from_list(InsertPermissionEntry.from_dict, x), from_none],
            obj.get("insert_permissions"),
        )
        is_enum = from_union([from_bool, from_none], obj.get("is_enum"))
        object_relationships = from_union(
            [lambda x: from_list(ObjectRelationship.from_dict, x), from_none],
            obj.get("object_relationships"),
        )
        remote_relationships = from_union(
            [lambda x: from_list(RemoteRelationship.from_dict, x), from_none],
            obj.get("remote_relationships"),
        )
        select_permissions = from_union(
            [lambda x: from_list(SelectPermissionEntry.from_dict, x), from_none],
            obj.get("select_permissions"),
        )
        update_permissions = from_union(
            [lambda x: from_list(UpdatePermissionEntry.from_dict, x), from_none],
            obj.get("update_permissions"),
        )
        return TableEntry(
            table,
            array_relationships,
    ...
    def to_dict(self) -> dict:
        ...
        result["array_relationships"] = from_union(
            [
                lambda x: from_list(lambda x: to_class(ArrayRelationship, x), x),
                from_none,
            ],
            self.array_relationships,
        )
        result["computed_fields"] = from_union(
            [lambda x: from_list(lambda x: to_class(ComputedField, x), x), from_none],
            self.computed_fields,
        )
        result["configuration"] = from_union(
            [lambda x: to_class(TableConfig, x), from_none], self.configuration
        )
        result["delete_permissions"] = from_union(
            [
                lambda x: from_list(lambda x: to_class(DeletePermissionEntry, x), x),
                from_none,
            ],
            self.delete_permissions,
        )
        result["event_triggers"] = from_union(
            [lambda x: from_list(lambda x: to_class(EventTrigger, x), x), from_none],
            self.event_triggers,
        )
        result["insert_permissions"] = from_union(
            [
                lambda x: from_list(lambda x: to_class(InsertPermissionEntry, x), x),
                from_none,
            ],
            self.insert_permissions,
        )
        result["is_enum"] = from_union([from_bool, from_none], self.is_enum)
        result["object_relationships"] = from_union(
            [
                lambda x: from_list(lambda x: to_class(ObjectRelationship, x), x),
                from_none,
            ],
            self.object_relationships,
        )
        result["remote_relationships"] = from_union(
            [
                lambda x: from_list(lambda x: to_class(RemoteRelationship, x), x),
                from_none,
            ],
            self.remote_relationships,
        )
        result["select_permissions"] = from_union(
            [
                lambda x: from_list(lambda x: to_class(SelectPermissionEntry, x), x),
                from_none,
            ],
            self.select_permissions,
        )
        result["update_permissions"] = from_union(
            [
                lambda x: from_list(lambda x: to_class(UpdatePermissionEntry, x), x),
                from_none,
            ],
...
class HasuraMetadataV2:
    ...
    def from_dict(obj: Any) -> "HasuraMetadataV2":
        ...
        actions = from_union(
            [lambda x: from_list(Action.from_dict, x), from_none], obj.get("actions")
        )
        allowlist = from_union(
            [lambda x: from_list(AllowList.from_dict, x), from_none],
            obj.get("allowlist"),
        )
        cron_triggers = from_union(
            [lambda x: from_list(CronTrigger.from_dict, x), from_none],
            obj.get("cron_triggers"),
        )
        custom_types = from_union(
            [CustomTypes.from_dict, from_none], obj.get("custom_types")
        )
        functions = from_union(
            [lambda x: from_list(CustomFunction.from_dict, x), from_none],
            obj.get("functions"),
        )
        query_collections = from_union(
            [lambda x: from_list(QueryCollectionEntry.from_dict, x), from_none],
            obj.get("query_collections"),
        )
        remote_schemas = from_union(
            [lambda x: from_list(RemoteSchema.from_dict, x), from_none],
            obj.get("remote_schemas"),
        )
        return HasuraMetadataV2(
            tables,
            version,
            actions,
            allowlist,
    ...
    def to_dict(self) -> dict:
        ...
        result["actions"] = from_union(
            [lambda x: from_list(lambda x: to_class(Action, x), x), from_none],
            self.actions,
        )
        result["allowlist"] = from_union(
            [lambda x: from_list(lambda x: to_class(AllowList, x), x), from_none],
            self.allowlist,
        )
        result["cron_triggers"] = from_union(
            [lambda x: from_list(lambda x: to_class(CronTrigger, x), x), from_none],
            self.cron_triggers,
        )
        result["custom_types"] = from_union(
            [lambda x: to_class(CustomTypes, x), from_none], self.custom_types
        )
        result["functions"] = from_union(
            [lambda x: from_list(lambda x: to_class(CustomFunction, x), x), from_none],
            self.functions,
        )
        result["query_collections"] = from_union(
            [
                lambda x: from_list(lambda x: to_class(QueryCollectionEntry, x), x),
                from_none,
            ],
            self.query_collections,
        )
        result["remote_schemas"] = from_union(
            [lambda x: from_list(lambda x: to_class(RemoteSchema, x), x), from_none],
            self.remote_schemas,
        )
        return result
...
def event_trigger_columns_from_dict(
    s: Any,
) -> Union[List[str], EventTriggerColumnsEnum]:
